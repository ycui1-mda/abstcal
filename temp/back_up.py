...
#         tlfb_df['imputation_code'] = DataImputationCode.RAW.value
...
#         imputation_code = DataImputationCode.code_for_missing_interval(start_amount, end_amount, self.abst_cutoff).value
